          ...
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                ...
                <TableHead className={`font-semibold min-w-[130px] text-black text-lg md:pl-0 md:-translate-x-4 ${isMobile ? 'pl-8' : ''}`}>Saldo</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredTransactions.map((transaction, index) => (
                <TableRow key={index} className="border-b hover:bg-gray-50">
                  ...
                  <TableCell className="text-green-600 min-w-[130px] -translate-x-6 whitespace-nowrap pr-1">{transaction.value}</TableCell>
                  <TableCell className={`min-w-[130px] md:pl-0 md:-translate-x-6 ${isMobile ? 'pl-8' : ''} whitespace-nowrap`}>{transaction.balance}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
