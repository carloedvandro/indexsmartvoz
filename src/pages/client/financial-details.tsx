          ...
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                ...
                <TableHead className="font-semibold min-w-[130px] text-black -ml-2 text-lg">Valor</TableHead>
            ...
            <TableBody>
              {filteredTransactions.map((transaction, index) => (
                <TableRow key={index} className="border-b hover:bg-gray-50">
                  ...
                  <TableCell className="text-green-600 min-w-[130px] -ml-2">{transaction.value}</TableCell>
