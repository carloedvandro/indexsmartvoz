          ...
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                ...
                <TableHead className="font-semibold min-w-[130px] text-black text-lg -translate-x-1.5">Valor</TableHead>
            ...
            <TableBody>
              {filteredTransactions.map((transaction, index) => (
                <TableRow key={index} className="border-b hover:bg-gray-50">
                  ...
                  <TableCell className="text-green-600 min-w-[130px] -translate-x-1.5">{transaction.value}</TableCell>
