          ...
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                ...
                <TableHead className="font-semibold min-w-[130px] text-black -ml-1 text-lg">Valor</TableHead>
                <TableHead className="font-semibold min-w-[130px] text-black -ml-1 text-lg">Saldo</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredTransactions.map((transaction, index) => (
                <TableRow key={index} className="border-b hover:bg-gray-50">
                  ...
                  <TableCell className="text-green-600 min-w-[130px] -ml-1">{transaction.value}</TableCell>
                  <TableCell className="min-w-[130px] -ml-1">{transaction.balance}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
