            ...
            <TableBody>
              {filteredTransactions.map((transaction, index) => (
                <TableRow key={index} className="border-b hover:bg-gray-50">
                  ...
                  <TableCell className="text-green-600 min-w-[130px] -translate-x-4 whitespace-nowrap">{transaction.value}</TableCell>
                  <TableCell className={`min-w-[130px] md:pl-0 md:-translate-x-1.5 ${isMobile ? 'pl-12' : ''} whitespace-nowrap`}>{transaction.balance}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
