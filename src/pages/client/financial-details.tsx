          ...
          <Table>
            <TableHeader className="bg-gray-50">
              <TableRow>
                ...
                <TableHead className="font-semibold min-w-[130px] text-black text-lg -translate-x-2">Valor</TableHead>
                <TableHead className="font-semibold min-w-[130px] text-black pl-0 text-lg -translate-x-2">Saldo</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredTransactions.map((transaction, index) => (
                <TableRow key={index} className="border-b hover:bg-gray-50">
                  ...
                  <TableCell className="text-green-600 min-w-[130px] -translate-x-2">{transaction.value}</TableCell>
                  <TableCell className="min-w-[130px] pl-0 -translate-x-2">{transaction.balance}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
