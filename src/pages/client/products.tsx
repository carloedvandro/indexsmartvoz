      ...
      <div className="container mx-auto p-4 pb-16 space-y-6">
        ...
        <div className="flex items-center justify-between mb-8 max-w-3xl mx-auto">
          ...
          <div className="flex items-center flex-1">
            ...
            <div className={`flex-1 h-1 ${currentStep >= 3 ? 'bg-[#8425af]' : 'bg-gray-200'} mx-2`} />
          </div>
          <div className="flex items-center flex-1">
            <div className={`w-8 h-8 rounded-full ${currentStep >= 3 ? 'bg-[#8425af]' : 'bg-gray-200'} text-white flex items-center justify-center`}>
              3
            </div>
            <div className={`flex-1 h-1 ${currentStep >= 4 ? 'bg-[#8425af]' : 'bg-gray-200'} mx-2`} />
          </div>
          <div className={`w-8 h-8 rounded-full ${currentStep >= 4 ? 'bg-[#8425af]' : 'bg-gray-200'} text-white flex items-center justify-center`}>
            4
          </div>
        </div>
