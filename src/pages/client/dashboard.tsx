          ...
          <div className="max-w-[1800px] mx-auto pt-24 -mt-[72px]">
            <div className="px-6 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="p-6 bg-[#7BC043]/20 text-[#7BC043] rounded-lg">
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#7BC043]/20 rounded-full">
                ...
                <Card className="p-6 bg-[#FFB84D]/20 text-[#FFB84D] rounded-lg">
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#FFB84D]/20 rounded-full">
                ...
                <Card className="p-6 bg-[#45B6FE]/20 text-[#45B6FE] rounded-lg">
                  <div className="flex items-center space-x-4">
                    <div className="p-3 bg-[#45B6FE]/20 rounded-full">
