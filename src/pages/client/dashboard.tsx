          ...
          <div className="max-w-[1800px] mx-auto pt-24 -mt-[72px]">
            <div className="px-6 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="p-6 bg-gradient-to-br from-[#8425af] via-[#6c1e8f] to-[#6c1e8f] hover:from-[#6c1e8f] hover:via-[#551872] hover:to-[#551872] transition-all duration-300 text-white rounded-lg border-0 cursor-pointer shadow-lg hover:shadow-xl animate-gradient bg-[length:400%_400%]">
