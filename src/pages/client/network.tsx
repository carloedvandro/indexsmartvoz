...
export default function NetworkPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 scrollbar-hide overflow-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 scrollbar-hide overflow-hidden">
