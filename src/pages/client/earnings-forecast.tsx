...
export default function EarningsForecast() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="fixed top-0 left-0 right-0 h-16 bg-gradient-to-r from-[#ff0000] to-[#5f0889] border-b border-white/10 z-40" style={{ background: 'linear-gradient(80deg, #ff0000, #5f0889)' }}>
