...
export const VerificationComplete = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-purple-900 to-purple-600 flex flex-col items-center justify-center p-4">
      <div className="px-4 py-4 rounded-lg border border-white/20 overflow-hidden max-w-md w-full text-center" style={{ backgroundColor: '#660099' }}>
      ...
      <Button onClick={() => navigate('/client/user-dashboard')} className="w-full max-w-md rounded-lg border border-white/20 overflow-hidden bg-transparent text-white hover:bg-white/10 font-bold py-3 mt-4">
        Acessar Painel
      </Button>
    </div>;
};