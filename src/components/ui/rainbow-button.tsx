  ...
  return (
    <button
      className={cn(
        ...
        // light mode colors
        "bg-[linear-gradient(#5f0889,#5f0889),linear-gradient(#5f0889_50%,rgba(95,8,137,0.8)_80%,rgba(95,8,137,0)),linear-gradient(90deg,hsl(var(--color-1)),hsl(var(--color-5)),hsl(var(--color-3)),hsl(var(--color-4)),hsl(var(--color-2)))]",
