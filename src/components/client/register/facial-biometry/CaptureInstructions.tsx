...
export const CaptureInstructions = ({ onNext }: CaptureInstructionsProps) => {
  return (
    <div className="bg-white text-gray-800 h-screen flex flex-col overflow-hidden">
      ...
      <div className="bg-white px-4 py-6 flex-shrink-0">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          {/* Text content */}
          <h2 className="text-lg font-medium mb-2 text-gray-800">Olá,</h2>
          <p className="text-sm font-light leading-relaxed text-center text-gray-600 max-w-xs">
      ...
      <div className="flex-shrink-0">
        <Button
          onClick={onNext}
          className="w-full h-14 bg-[#8425af] text-white uppercase text-sm font-medium hover:bg-[#7a1fa2] rounded-none"
        >
          AVANÇAR
        </Button>
      </div>
