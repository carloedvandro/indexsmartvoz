...
export const DocumentInstructionsStep = ({ onNext }: DocumentInstructionsStepProps) => {
  return (
    <div className="bg-white text-gray-800 min-h-[calc(100vh-100px)] relative flex flex-col justify-between">
      ...
      {/* Button outside of the main container moved further down */}
      <button
        onClick={onNext}
        className="w-full h-12 bg-[#8425af] text-white uppercase text-xs font-medium hover:bg-[#7a1fa2] mt-[20px]"
      >
        AVANÇAR
      </button>
    </div>
