              ...
              <div className="relative rounded-md">
                <div className="absolute left-3 top-1/2 -translate-y-1/2 text-[#5f0889] h-4 w-4">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <path className="animate-ping-slow opacity-75" d="M13 4 C 15 6, 17 7, 19 8"></path>
                    <path className="animate-ping-slow opacity-75 animation-delay-200" d="M12 7 C 14 8, 16 9, 18 10"></path>
                  </svg>
                </div>
                <Input 
                  {...field} 
