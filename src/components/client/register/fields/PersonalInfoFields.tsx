      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input {...field} className="bg-transparent text-sm h-8 pt-[9px]" />
            </FormControl>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input type="email" {...field} className="bg-transparent text-sm h-8 pt-[9px]" />
            </FormControl>
            <FormMessage className="text-xs" />
          </FormItem>
        )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="date" {...field} className="bg-transparent text-sm h-8 pt-[9px]" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )}
