      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input {...field} className="bg-transparent text-sm h-7" />
            </FormControl>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input type="email" {...field} className="bg-transparent text-sm h-7" />
            </FormControl>
            <FormMessage className="text-xs" />
          </FormItem>
        )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="date" {...field} className="bg-transparent text-sm h-7" />
              </FormControl>
              <FormMessage className="text-xs" />
            </FormItem>
          )}
