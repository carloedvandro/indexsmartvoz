...
export function NotificationDropdown({ showNotifications, onToggleNotifications }: NotificationDropdownProps) {
  ...
  return (
    <div className="relative" style={{ marginRight: '2px' }}>
      ...
      {showNotifications && (
        <div className="absolute top-full w-[320px] max-w-[90vw] bg-white border border-gray-200 rounded-b-lg shadow-lg z-[5] right-3 md:-right-[13px]" style={{ marginTop: '17.9px' }}>
          <div className="p-4">
