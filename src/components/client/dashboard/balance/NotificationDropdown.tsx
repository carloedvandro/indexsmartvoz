...
export function NotificationDropdown({ showNotifications, onToggleNotifications }: NotificationDropdownProps) {
  ...
  return (
    <div className="relative" style={{ marginRight: '2px' }}>
      ...
      {showNotifications && (
        <div className="absolute right-0 sm:left-1/2 sm:transform sm:-translate-x-1/2 top-full w-[320px] max-w-[90vw] bg-white border border-gray-200 rounded-b-lg shadow-lg z-[5]" style={{ marginTop: '17.9px' }}>
          <div className="p-4">
