...
export function NotificationDropdown({ showNotifications, onToggleNotifications }: NotificationDropdownProps) {
  ...
  return (
    <div className="relative" style={{ marginRight: '2px' }}>
      ...
      {showNotifications && (
        <div className="absolute top-full w-[420px] max-w-[90vw] bg-white border border-gray-200 rounded-b-lg shadow-lg z-[5] -right-[130px] md:-right-[65px]" style={{ marginTop: '17.9px' }}>
          <div className="p-4">
