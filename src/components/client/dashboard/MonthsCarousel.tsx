...
export function MonthsCarousel({ months, activeMonth, setActiveMonth }: MonthsCarouselProps) {
  ...
  return (
    <div className="px-28 mb-6 relative">
      <Carousel className="w-full" opts={{ align: "start" }}>
        <CarouselPrevious className="absolute -left-18 top-1/2 -translate-y-1/2 z-10" />
        ...
        <CarouselNext className="absolute -right-18 top-1/2 -translate-y-1/2 z-10" />
      </Carousel>
    </div>
  );
}
