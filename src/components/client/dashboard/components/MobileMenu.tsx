...
export const MobileMenu = ({ isOpen, setOpen, navigationItems, onLogout }: MobileMenuProps) => {
  ...
  return (
    <div className="flex lg:hidden ml-auto items-center h-full">
      ...
      {isOpen && (
        <div className="fixed top-20 left-0 right-0 flex flex-col w-[350px] mx-auto bg-white shadow-lg py-2 container mobile-menu-container gap-2 z-50 rounded-b-lg">
