  ...
  return (
    <div className={"w-full"}>
      <button 
        ...
        className={cn(
          "text-gray-700 mx-auto hover:text-gray-900 font-medium rounded-md h-12 w-16 lg:w-12 flex items-center justify-center transition-all duration-300 bg-transparent border-none p-0",
          className
        )}
        aria-label="Logout"
      >
