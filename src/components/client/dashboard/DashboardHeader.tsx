...
export function DashboardHeader({ title = "Dashboard", subtitle, icon }: DashboardHeaderProps) {
  ...
  return (
    <header className="w-full">
      <div className="bg-white shadow border rounded-lg flex justify-between items-center px-16 py-2">
        ...
        <button
          ...
          className="flex items-center gap-2 text-gray-600 hover:text-gray-900 pr-4"
        >
