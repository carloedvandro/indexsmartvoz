      ...
      <div className="py-2 bg-transparent pt-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          <motion.div
            ...
            className="relative rounded-[1rem] px-6 py-4 border-2 border-yellow-200 bg-gradient-to-br from-yellow-100 to-yellow-50 shadow-xl overflow-hidden hover:scale-[1.03] transition-transform duration-500"
          >
            <div className="absolute inset-0 rounded-[1rem] border border-white/40 pointer-events-none z-0" />
          ...
          <motion.div
            ...
            className="relative rounded-[1rem] px-6 py-4 border-2 border-lime-200 bg-gradient-to-br from-lime-100 to-green-50 shadow-xl overflow-hidden hover:scale-[1.03] transition-transform duration-500"
          >
            <div className="absolute inset-0 rounded-[1rem] border border-white/40 pointer-events-none z-0" />
            <div className="relative z-10">
          ...
          <motion.div
            ...
            className="relative rounded-[1rem] px-6 py-4 border-2 border-sky-200 bg-gradient-to-br from-sky-100 to-blue-50 shadow-xl overflow-hidden hover:scale-[1.03] transition-transform duration-500"
          >
            <div className="absolute inset-0 rounded-[1rem] border border-white/40 pointer-events-none z-0" />
            <div className="relative z-10">
          ...
          <motion.div
            ...
            className="relative rounded-[1rem] px-6 py-4 border-2 border-pink-200 bg-gradient-to-br from-pink-100 to-pink-50 shadow-xl overflow-hidden hover:scale-[1.03] transition-transform duration-500"
          >
            <div className="absolute inset-0 rounded-[1rem] border border-white/40 pointer-events-none z-0" />
            <div className="relative z-10">
