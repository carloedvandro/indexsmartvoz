    ...
    <>
      ...
      >
        ...
        <motion.div
          ...
          onMouseEnter={() => handleRegionHover('nordeste')}
          onMouseLeave={handleRegionLeave}
        >
          <div className="w-full h-full rounded-lg transition-all duration-300 flex items-center justify-center hover:bg-white/10">
        ...
        <motion.div
          ...
          onMouseEnter={() => handleRegionHover('centrooeste')}
          onMouseLeave={handleRegionLeave}
        >
          <div className="w-full h-full rounded-lg transition-all duration-300 flex items-center justify-center hover:bg-white/10">
        ...
        <motion.div
          ...
          onMouseEnter={() => handleRegionHover('sudeste')}
          onMouseLeave={handleRegionLeave}
        >
          <div className="w-full h-full rounded-lg transition-all duration-300 flex items-center justify-center hover:bg-white/10">
        ...
        <motion.div
          ...
          onMouseEnter={() => handleRegionHover('sul')}
          onMouseLeave={handleRegionLeave}
        >
          <div className="w-full h-full rounded-lg transition-all duration-300 flex items-center justify-center hover:bg-white/10">
            {activeRegion === 'sul' && (
