...
export function MapOverlay({ regionsData, activeRegion, setActiveRegion }: MapOverlayProps) {
  return (
    <div className="absolute inset-0 w-full h-full">
      ...
      {/* Sudeste - área vermelha centro-direita - ajustada para mobile */}
      <motion.div
        className="absolute cursor-pointer"
        style={{
          top: 'calc(50% - 120px)', // Movida mais para cima no mobile
          right: 'calc(15% + 45px)',
          width: '40%',
          height: '25%',
        }}
      ...
      {Object.entries(regionsData).map(([key, region], index) => {
        const positions = {
          ...
          sudeste: { top: 'calc(62% - 120px)', right: 'calc(23% + 45px)', transform: 'translate(50%, -50%)' },
