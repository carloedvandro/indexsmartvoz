        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              />
              <span 
                className="font-bold text-left text-gray-600 -ml-[20px] pl-[20px] mt-[14px]" 
                style={{
                  fontSize: '1rem'
                }}
              >
              ...
              <>
                <DropdownMenuItem asChild>
                  <Link to={homeItem.href} className="flex items-center gap-2 cursor-pointer focus:outline-none focus:border-0 w-full py-3 bg-white rounded-md border border-gray-100">
                    ...
                    />
                    <span className="font-bold self-center text-gray-600 text-lg pl-[10px] mt-[14px]">Home</span>
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
              </>
