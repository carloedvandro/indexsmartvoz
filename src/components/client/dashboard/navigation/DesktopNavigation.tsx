      ...
      {homeItem && (
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <span 
                className="font-bold text-left text-gray-600 -ml-[20px] pl-[20px] mt-[15px] text-xl bg-clip-text text-transparent bg-gradient-to-r from-[#F36B44] via-[#8E44AD] to-[#2980B9]"
              >
                SMARTVOZ
              </span>
            </Button>
              ...
              <>
                <DropdownMenuItem asChild>
                  <Link to={homeItem.href} className="flex items-center gap-2 cursor-pointer focus:outline-none focus:border-0 w-full py-3 bg-white rounded-md border border-gray-100">
                    <span className="font-bold self-center text-gray-600 text-xl bg-clip-text text-transparent bg-gradient-to-r from-[#F36B44] via-[#8E44AD] to-[#2980B9] pl-[10px] mt-[15px]">
                      SMARTVOZ
                    </span>
                  </Link>
                </DropdownMenuItem>
