            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <span className="text-xl font-semibold text-green-600">
                  R$ <span className="text-green-600">{activeMonthData.upValue.toLocaleString('pt-BR')}</span>
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <span className="text-xl font-semibold text-red-600">
                  - R$ <span className="text-red-600">{activeMonthData.downValue.toLocaleString('pt-BR')}</span>
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <span className="text-xl font-semibold text-blue-600">
                  R$ <span className="text-blue-600">{balance.toLocaleString('pt-BR')}</span>
                </span>
              </div>
            </div>
          </div>
