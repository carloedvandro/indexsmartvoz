...
export function FinancialSummary() {
  return (
    <div className="px-6 grid grid-cols-1 lg:grid-cols-5 gap-4 mb-6">
      ...
      {/* Comparação card */}
      <div className="lg:col-span-1 bg-white p-6 rounded-xl shadow ml-auto" style={{ maxWidth: '400px' }}>
      ...
      {/* Para acontecer card */}
      <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow ml-auto" style={{ maxWidth: '400px' }}>
