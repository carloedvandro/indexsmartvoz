...
export function BarcodeScannerComponent({ selectedLines, onStartScanning }: BarcodeScannerProps) {
  return (
    <div className="space-y-6 w-full max-w-[320px] mx-auto px-4 overflow-hidden">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="bg-[#8425af] hover:bg-[#6c1e8f] px-4 h-[42px] flex items-center whitespace-nowrap"
                  >
