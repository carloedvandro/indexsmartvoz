...
export function BarcodeScannerComponent({ selectedLines, onStartScanning }: BarcodeScannerProps) {
  return (
    <div className="space-y-6 w-[320px] mx-auto">
      <h2 className="text-lg font-semibold text-center whitespace-nowrap">Escaneie o código de barra do chip</h2>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="bg-[#8425af] hover:bg-[#6c1e8f] px-4 h-9 flex items-center"
                  >
