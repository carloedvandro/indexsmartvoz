...
export function BarcodeScannerComponent({ selectedLines, onStartScanning }: BarcodeScannerProps) {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-center pt-[10mm] w-[calc(100%+2mm)]">Escaneie o código de barra do chip</h2>
            ...
            <div className="p-5 border rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">{line.ddd}</p>
                </div>
                <Button
