...
interface ActivationTypeStepProps {
  activationType: 'self' | 'other';
  onTypeChange: (value: 'self' | 'other') => void;
}

export function ActivationTypeStep({ activationType, onTypeChange }: ActivationTypeStepProps) {
  return (
    <div className="space-y-6">
      ...
      <RadioGroup value={activationType} onValueChange={onTypeChange}>
