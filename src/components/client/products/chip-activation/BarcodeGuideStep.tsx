      ...
      <div className="w-full max-w-md mx-auto p-4 space-y-4">
        ...
        <div className="pt-6 space-y-8 ">
          <div className="space-y-7 mt-6">
            <h2 className="text-2xl font-bold scale-[1.05] origin-left">Confira como você encontra o código de barras do SIM card</h2>
            ...
            <div className="flex items-center justify-between max-w-md mx-auto mb-4 mt-1">
              ...
              <div className="flex flex-col items-center">
                <div className="w-7 h-7 rounded-full border-2 border-[#8425af] flex items-center justify-center text-[#8425af] animate-pulse">
                  <Circle className="w-3 h-3 fill-[#8425af] stroke-[#8425af] animate-blink" />
                </div>
          ...
          <div className="flex justify-end gap-3">
            <Button variant="outline" onClick={onBack} className="px-4 py-4 bg-transparent backdrop-blur-sm rounded-lg border border-white/30 shadow-lg mb-4">
              Voltar
            </Button>
            <Button className="px-4 py-4 bg-transparent backdrop-blur-sm rounded-lg border border-white/30 shadow-lg mb-4" onClick={onContinue}>
              Continuar
            </Button>
          </div>
        </div></div></div>;
