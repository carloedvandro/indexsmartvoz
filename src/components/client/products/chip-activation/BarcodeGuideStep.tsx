        ...
        <div className="pt-6 space-y-8 ">
          <div className="space-y-7">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 scale-[1.035] origin-left">
                O código de barras está impresso no cartão do Chip, tem 20 números e começa com 8955, conforme o exemplo:
              </p>

              <img src="/lovable-uploads/8592bc80-f516-440a-a660-d17446a9528d.png" alt="Exemplo de código de barras do SIM card" className="max-w-full h-auto scale-108" />
            </div>
          </div>
