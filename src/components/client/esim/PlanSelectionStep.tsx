...
export function PlanSelectionStep({ onBack, onContinue }: PlanSelectionStepProps) {
  ...
  return (
    <div className="max-w-[380px] mx-auto w-full pt-6">
      <div className="space-y-8">
        ...
        <div className="space-y-4">
          <div className="w-full px-3 max-w-[380px] mx-auto">
        ...
        <div className="w-full px-3 max-w-[380px] mx-auto flex justify-between pt-4">
          <Button 
            variant="outline" 
