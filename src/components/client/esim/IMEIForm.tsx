      ...
      <form onSubmit={handleSubmit} className="w-full space-y-6">
        <div className="space-y-2">
          <Input
            ...
            className={`w-full text-center text-lg rounded-lg border-2 border-[#8425af] focus:ring-2 focus:ring-[#8425af] focus:border-[#8425af] ${
              deviceInfo ? 'ring-2 ring-green-500 border-green-500' : 
              imei.length === 15 && !deviceInfo ? 'ring-2 ring-red-500 border-red-500' : ''
            }`}
          />
