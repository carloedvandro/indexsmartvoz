          ...
          <div className="border rounded-xl card-no-bg">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="w-full h-4 bg-gray-100 rounded-sm mb-4 overflow-hidden cursor-pointer group">
                  <div className="h-full flex group-hover:h-6 transition-all duration-200">
                    <div 
                      className="h-full bg-[#27ae60] rounded-sm transition-all duration-200" 
                      style={{ width: '70%' }}
                    ></div>
                    <div 
                      className="h-full bg-[#27ae60]/60 rounded-sm transition-all duration-200" 
                      style={{ width: '30%' }}
                    ></div>
                  </div>
                </div>
              ...
              <TooltipContent className="bg-black text-white p-2 rounded">
                <div className="text-sm">
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.received.amount).pixAmount)} no Pix</div>
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.received.amount).boletoAmount)} no Boleto Bancário</div>
                </div>
              </TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="w-full h-4 bg-gray-100 rounded-sm mb-4 overflow-hidden cursor-pointer group">
                  <div className="h-full flex group-hover:h-6 transition-all duration-200">
                    <div 
                      className="h-full bg-[#3498db] rounded-sm transition-all duration-200" 
                      style={{ width: '70%' }}
                    ></div>
                    <div 
                      className="h-full bg-[#3498db]/60 rounded-sm transition-all duration-200" 
                      style={{ width: '30%' }}
                    ></div>
                  </div>
                </div>
              ...
              <TooltipContent className="bg-black text-white p-2 rounded">
                <div className="text-sm">
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.confirmed.amount).pixAmount)} no Pix</div>
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.confirmed.amount).boletoAmount)} no Boleto Bancário</div>
                </div>
              </TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="w-full h-4 bg-gray-100 rounded-sm mb-4 overflow-hidden cursor-pointer group">
                  <div className="h-full flex group-hover:h-6 transition-all duration-200">
                    <div 
                      className="h-full bg-[#f39c12] rounded-sm transition-all duration-200" 
                      style={{ width: '70%' }}
                    ></div>
                    <div 
                      className="h-full bg-[#f39c12]/60 rounded-sm transition-all duration-200" 
                      style={{ width: '30%' }}
                    ></div>
                  </div>
                </div>
              ...
              <TooltipContent className="bg-black text-white p-2 rounded">
                <div className="text-sm">
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.awaiting.amount).pixAmount)} no Pix</div>
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.awaiting.amount).boletoAmount)} no Boleto Bancário</div>
                </div>
              </TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="w-full h-4 bg-gray-100 rounded-sm mb-4 overflow-hidden cursor-pointer group">
                  <div className="h-full flex group-hover:h-6 transition-all duration-200">
                    <div 
                      className="h-full bg-[#e74c3c] rounded-sm transition-all duration-200" 
                      style={{ width: '70%' }}
                    ></div>
                    <div 
                      className="h-full bg-[#e74c3c]/60 rounded-sm transition-all duration-200" 
                      style={{ width: '30%' }}
                    ></div>
                  </div>
                </div>
              ...
              <TooltipContent className="bg-black text-white p-2 rounded">
                <div className="text-sm">
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.overdue.amount).pixAmount)} no Pix</div>
                  <div>{formatCurrencyBR(getPaymentBreakdown(billingStatus.overdue.amount).boletoAmount)} no Boleto Bancário</div>
                </div>
              </TooltipContent>
            </Tooltip>
