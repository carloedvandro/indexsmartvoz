            ...
            <SelectContent className="bg-white border border-gray-200 rounded-md shadow-md z-50">
              {months.map((month) => (
                <SelectItem 
                  key={month.value} 
                  value={month.value}
                  className="cursor-pointer py-1.5 px-2 bg-white hover:bg-gray-100 focus:bg-white focus:text-[#5f0889] data-[state=checked]:bg-white data-[state=checked]:text-[#5f0889]"
                >
                  {month.label}
                </SelectItem>
              ))}
