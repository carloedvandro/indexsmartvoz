...
export function BalanceCards({ selectedMonth, selectedYear, months, onCardClick }: BalanceCardsProps) {
  return (
    <div className="grid grid-cols-1 gap-4">
      ...
      >
        <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-gradient-to-b from-[#000000] to-[#3533cd]" />
        <div className="flex justify-between items-center">
          <span className="text-[#3533cd] font-medium">Saldo disponível</span>
          <div className="flex items-center gap-1">
            <span className="text-[#3533cd]">R$</span>
            <span className="text-[#3533cd] text-xl">5.000,01</span>
          </div>
        </div>
      </Card>
