...
export function FinancialSummary({ 
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 md:gap-4 mb-6 md:mb-8 mx-auto w-full md:w-[540px]">
      <div 
        className="bg-gradient-to-r from-[#000000] to-[#5f0889] text-white py-3 px-5 rounded-lg w-full md:flex-1 cursor-pointer hover:opacity-90 transition-opacity relative overflow-hidden"
