...
export function PlanCard({ plan, onSelect }: PlanCardProps) {
  ...
  return (
    <Card className={`plan-card-container h-full flex flex-col overflow-hidden transition-all w-full max-w-[350px] mx-auto rounded-3xl relative ${bgColor} text-white`}>
