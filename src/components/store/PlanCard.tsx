...
export function PlanCard({ plan, onSelect }: PlanCardProps) {
  ...
  return (
    <Card className={`plan-card-container h-full flex flex-col overflow-hidden transition-all w-full min-w-[300px] max-w-[400px] mx-auto rounded-3xl relative ${bgColor} text-white`}>
