        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              <span className="text-purple-800">Conecte-se</span> e expanda seu negócio
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/">
                <Button className="w-full sm:w-auto bg-purple-800 hover:bg-purple-900 text-white px-8 py-3 rounded-lg">
                  Portal do Cliente
                </Button>
              </Link>
              <a href="#plans">
                <Button variant="outline" className="w-full sm:w-auto px-8 py-3 rounded-lg">
                  Ver Planos
                </Button>
              </a>
            </div>
