...
const features = [
  {
    icon: <PhoneCall className="w-8 h-8 text-purple-800 dark:text-purple-400" />,
  ...
  {
    icon: <Wifi className="w-8 h-8 text-purple-800 dark:text-purple-400" />,
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="flex flex-col items-start">
                <div className="mb-4 p-3 bg-purple-100 dark:bg-purple-900/30 rounded-lg">{feature.icon}</div>
