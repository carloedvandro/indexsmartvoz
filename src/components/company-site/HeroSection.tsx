  ...
  return (
    <section id="home" className="pt-28 pb-20 bg-[#030225] min-h-screen flex items-center relative overflow-hidden">
      <div className="container mx-auto px-4 z-10">
        ...
        >
          <h1 className="text-2xl md:text-4xl font-extrabold mb-6 text-white font-dosis tracking-tight">
          ...
          <p className="text-lg text-gray-300 mb-10 max-w-3xl mx-auto font-dosis">
          ...
          <Link to="/client/register">
            <Button 
              size="lg" 
              className="bg-[#ff0066] hover:bg-[#d4004f] text-white rounded-full px-8 py-3 text-base font-dosis"
            >
