...
export function HeroSection() {
  return (
    <section id="home" className="pt-28 pb-20 bg-[#030225] min-h-screen flex items-center relative overflow-hidden">
      {/* Rede de pontos à esquerda - rede geométrica vermelha */}
      <div className="absolute left-0 top-1/4 -translate-y-1/2 w-[400px] h-[400px] opacity-90">
        <img
          src="/lovable-uploads/513f791e-3dfb-40ed-8a76-90a2afd3aa12.png"
          alt="Network Mesh"
          className="w-full h-full object-contain"
        />
      </div>
      
      {/* Rede de pontos à direita */}
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          <div className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-white">
            <div>Seu Parceiro de <span className="text-[#ff0066]">Confiança</span> no</div>
            <div>Mercado Móvel <span className="text-[#ff0066]">Com Cobertura</span></div>
            <div><span className="text-[#ff0066]">Imbatível</span></div>
          </div>
          
          <p className="text-lg text-gray-300 mb-10 max-w-3xl">
            Transforme sua empresa em uma operadora digital de telefonia móvel com a SmartVoz. 
