...
export function BenefitsModal({ 
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<BenefitFormData>();
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
          ...
          <div>
            ...
            {errors.display_order && (
              <span className="text-sm text-red-600">{errors.display_order.message}</span>
            )}
          </div>
